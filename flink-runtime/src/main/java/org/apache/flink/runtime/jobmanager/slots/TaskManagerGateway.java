...
public interface TaskManagerGateway extends TaskExecutorOperatorEventGateway {
    ...
    /**
     * Send control message to the given task.
     *
     * @param executionAttemptID identifying the task
     * @param timeout of the submit operation
     * @return Future acknowledge if the task is successfully canceled
     */
    CompletableFuture<?> sendControlToTask(ExecutionAttemptID executionAttemptID, Duration timeout, ControlMessage controlMessage);
